...
mkdir ~/.vnc
curl -o ~/.vnc/xstartup https://raw.githubusercontent.com/arfshl/debian-on-android/main/mate/xstartup
...
curl -o /usr/local/bin/vncserver-stop https://raw.githubusercontent.com/AndronixApp/AndronixOrigin/master/APT/MATE/vncserver-stop 
