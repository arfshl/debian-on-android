...
echo "Installing i3..."
apt install keyboard-configuration dialog libexo-2-0 i3 tigervnc-standalone-server nano dbus-x11 xorg xfce4-terminal thunar cairo-dock tigervnc-common --no-install-recommends -y
apt-get clean
echo "Setting up i3..."
mkdir ~/.vnc
