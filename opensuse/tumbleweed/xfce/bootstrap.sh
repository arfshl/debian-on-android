...
proot-distro login opensuse-tumbleweed-xfce -- /bin/sh -c 'wget https://raw.githubusercontent.com/arfshl/proot-distro-desktop/refs/heads/main/opensuse/tumbleweed/xfce/install.sh -O install.sh && chmod +x install.sh && ./install.sh && rm install.sh'
...
echo 'Default user: opensuse-tumbleweed-xfce'
