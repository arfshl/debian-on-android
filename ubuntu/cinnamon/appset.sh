#!/bin/sh
# Install Apps
apt update && apt install chromium firefox vlc thunderbird engrampa evince eog mate-calc pluma libheif1 webp-pixbuf-loader fonts-liberation p7zip -y && apt clean
