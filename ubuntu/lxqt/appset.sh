#!/bin/sh
sudo apt update && sudo apt install chromium firefox vlc thunderbird lximage-qt kcalc lxqt-archiver okular libheif1 webp-pixbuf-loader fonts-liberation p7zip featherpad -y && apt clean"
