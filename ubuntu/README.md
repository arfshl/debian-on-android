...
#### Install Web Browser, Media Player, Utility (Execute on rootfs)
    sudo apt update && sudo apt install firefox vlc thunderbird engrampa atril eog mate-calc pluma libheif1 webp-pixbuf-loader fonts-liberation p7zip -y && apt clean
