...
# for CLI session
printf 'proot-distro login ubuntu-xfce --user ubuntu-xfce' >> /data/data/com.termux/files/usr/bin/startubuntu-xfce
...
# Setup ubuntu-xfce
proot-distro login ubuntu-xfce -- /bin/sh -c 'wget 