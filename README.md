...
- Install Ubuntu
      ...
      apt update && apt dist-upgrade && apt install proot-distro -y && proot-distro install ubuntu && echo 'To start Ubuntu use proot-distro login ubuntu command'

- Install Debian

      apt update && apt dist-upgrade && apt install proot-distro -y && proot-distro install debian && echo 'To start Debian use proot-distro login debian command'
